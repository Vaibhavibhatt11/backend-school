...
const envSchema = z.object({
  ...
  API_RATE_LIMIT_MAX_PER_IP: z.coerce.number().int().positive().default(300),
  API_RATE_LIMIT_USE_REDIS: z.enum(["true", "false"]).default("false"),
  CACHE_ENABLED: z.enum(["true", "false"]).default("true"),
  CACHE_TTL_DASHBOARD_SEC: z.coerce.number().int().min(0).default(90),
