class ApiEndpoints {
  ...
  static const String parentFinanceHub = '/parent/finance-hub';
  ...
  static String parentEventRegister(String eventId) =>
      '/parent/events/$eventId/register';
  static String parentEventCancel(String eventId) =>
      '/parent/events/$eventId/cancel';
  static const String parentAchievements = '/parent/achievements';
  ...
  static const String staffCommunicationMeetings =
