...
class TeacherShellController extends GetxController {
  final RxInt currentIndex = 0.obs;

  static const Map<String, int> _routeIndexMap = {
    AppRoutes.TEACHER_HOME: 0,
    AppRoutes.TEACHER_ATTENDANCE_SELECTOR: 1,
    AppRoutes.TEACHER_LIVE_CLASS: 2,
    AppRoutes.TEACHER_TIMETABLE: 3,
    AppRoutes.TEACHER_PROFILE: 4,
  };
