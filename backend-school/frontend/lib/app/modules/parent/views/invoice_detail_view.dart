      ...
      appBar: CustomAppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () =>
                controller.loadInvoice(controller.invoiceRecordId.value),
          ),
        ],
      ),
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Obx(
                () => Column(
                  children: controller.breakdown.map((item) {
                    return Padding(
                      padding: const EdgeInsets.all(16),
                      child: Row(
                        children: [
            ...
            Obx(
              () => Column(
                children: controller.paymentHistory.map((payment) {
                  return Container(
      ...
      floatingActionButton: Padding(
        ...
        child: Obx(
          () => FloatingActionButton.extended(
            ...
            label: Text(
              'Pay Balance (\$${controller.totalDue.value.toStringAsFixed(2)})',
            ),
