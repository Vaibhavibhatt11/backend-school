...
class StaffStudyMaterialLibraryView extends StatefulWidget {
  const StaffStudyMaterialLibraryView({super.key});

  @override
  State<StaffStudyMaterialLibraryView> createState() =>
      _StaffStudyMaterialLibraryViewState();
}

class _StaffStudyMaterialLibraryViewState
    extends State<StaffStudyMaterialLibraryView> {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(
        ...
        actions: [
          IconButton(
            tooltip: 'Refresh',
            onPressed: () => controller.loadInitialData(showErrors: true),
          ...
          child: ListView(
            ...
            children: [
              ...
              if (controller.isLoading.value && controller.materials.isEmpty)
                ...
                _EmptyLibraryState(
                  label: staffStudyMaterialEmptyLabel(category),
