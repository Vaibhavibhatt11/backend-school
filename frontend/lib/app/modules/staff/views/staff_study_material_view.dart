...
class StaffStudyMaterialView extends GetView<StaffStudyMaterialController> {
  const StaffStudyMaterialView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        const categories = StaffStudyMaterialCategory.values;
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Manage notes, videos, PDFs, and learning resources from one staff workflow.',
                          ...
                          .map(
                            (category) => _QuickPublishChip(
                              ...
                              onTap: () => SafeNavigation.toNamed(
                                AppRoutes.STAFF_STUDY_MATERIAL_COMPOSER,
                  ...
                  return Wrap(
                    ...
                    children: categories.map((category) {
                      return _ActionCard(
                        ...
                        onTap: () => SafeNavigation.toNamed(
                          AppRoutes.STAFF_STUDY_MATERIAL_LIBRARY,
                          arguments: {'category': category.value},
                        ),
                      );
                    }).toList(),
              ...
              _SectionHeader(
                ...
                onAction: () => SafeNavigation.toNamed(
                  AppRoutes.STAFF_STUDY_MATERIAL_LIBRARY,
                  arguments: {
                    'category': StaffStudyMaterialCategory.notes.value,
                  },
                ),
              ),
              ...
              if (recentItems.isEmpty)
                ...
                ...recentItems.map(
                  (item) => _MaterialTile(
                    item: item,
                    onTap: () => SafeNavigation.toNamed(
                      AppRoutes.STAFF_STUDY_MATERIAL_DETAIL,
...
class _ActionCard extends StatelessWidget {
  ...
  final double width;
  final StaffStudyMaterialCategory category;
  final int count;
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                staffStudyMaterialDescription(category),
                style: TextStyle(
                  color: isDark
...
class _MaterialTile extends StatelessWidget {
  ...
  final StaffStudyMaterialRecord item;
  final VoidCallback onTap;
    ...
    return Container(
      ...
      child: ListTile(
        ...
        leading: Container(
          ...
          child: Icon(staffStudyMaterialIcon(item.category), color: color),
        ),
        title: Text(
          item.title,
          style: TextStyle(
